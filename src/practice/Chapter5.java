...
public class Chapter5 {
	...
	public static void main(String[] args) throws Exception {
		...
		List<Task> taskList = new ArrayList<>();//1つの要素にLocalDateとActionの二つをもつ空のリストを作成するには<>がStringとかではダメ。コンストラクタTask使用。ラムダ式
		...
		for(Task task : taskList) {
			System.out.println(task.getDate().format(dateTimeFormatter) + "：" + task.getAction());
